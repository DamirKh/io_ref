...
def write_io_map_yaml():
    ...
    for CHASSI in project_chass:
        ...
        for SLOT in io_config[CHASSI].keys():
            ...
            ms.write(yaml.safe_dump(io_map, default_flow_style=False, allow_unicode=True, sort_keys=False))
    # yaml.dump(io_map, ms, default_flow_style=False, allow_unicode=True, sort_keys=False)
